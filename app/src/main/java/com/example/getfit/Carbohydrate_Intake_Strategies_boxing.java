...
public class Carbohydrate_Intake_Strategies_boxing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carbohydrate_intake_strategies_boxing);
        ...
        if (!savedWeight.isEmpty()) {
            ...
            float easyHighValue = (float) (3.1 * weight);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_item_layout1) {
                    Intent intent = new Intent(Carbohydrate_Intake_Strategies_boxing.this, MainActivity.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout2) {
                    Intent intent = new Intent(Carbohydrate_Intake_Strategies_boxing.this, Boxing.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout3) {
                    Intent intent = new Intent(Carbohydrate_Intake_Strategies_boxing.this, Login.class);
                    startActivity(intent);
                }
                return true;
            }
