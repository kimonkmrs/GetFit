...
public class Carbohydrate_Intake_Strategies_Football extends AppCompatActivity {
    ImageView back, menu;
    EditText mWeight, mEasyLow, mEasyHigh,mMidLow,mMidHigh,mGamePrep1;

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_carbohydrate_intake_strategies_football);
        ...
        mGamePrep1=findViewById(R.id.count_match_prep);
        ...
        if (!savedWeight.isEmpty()) {
            ...
            float midLowValue= 7 * weight;
            float midHighValue= 10 * weight;
            float GamePrep1 = 9 * weight;
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_item_layout1) {
                    Intent intent = new Intent(Carbohydrate_Intake_Strategies_Football.this, MainActivity.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout2) {
                    Intent intent = new Intent(Carbohydrate_Intake_Strategies_Football.this, Football.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout3) {
                    Intent intent = new Intent(Carbohydrate_Intake_Strategies_Football.this, Login.class);
                    startActivity(intent);
                }
                return true;
            }
