...
public class Day2_pre_season_tennis extends Fragment {
    @Nullable
    @Override
    public View onCreateView(
        ...
        View view = inflater.inflate(R.layout.fragment_day2_pre_season_tennis, container, false);
        ...
        backSquatsImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(requireContext(), VideoPlayerPreSeasonTennisDay2_1.class);
        ...
        backSquatsImageView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Launch the VideoPlayerFootball activity when the image is clicked
                Intent intent = new Intent(requireContext(), VideoPlayerPreSeasonTennisDay2_2.class);
                startActivity(intent);
            }
        });
        backSquatsImageView3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Launch the VideoPlayerFootball activity when the image is clicked
                Intent intent = new Intent(requireContext(), VideoPlayerPreSeasonTennisDay2_3.class);
                startActivity(intent);
            }
        });
        backSquatsImageView4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Launch the VideoPlayerFootball activity when the image is clicked
                Intent intent = new Intent(requireContext(), VideoPlayerPreSeasonTennisDay2_4.class);
                startActivity(intent);
            }
        });
        backSquatsImageView5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Launch the VideoPlayerFootball activity when the image is clicked
                Intent intent = new Intent(requireContext(), VideoPlayerPreSeasonTennisDay2_5.class);
                startActivity(intent);
            }
        });
        backSquatsImageView6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Launch the VideoPlayerFootball activity when the image is clicked
                Intent intent = new Intent(requireContext(), VideoPlayerPreSeasonTennisDay2_6.class);
                startActivity(intent);
            }
        });
