...
public class Specific_preparation_schedule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_specific_preparation_schedule); // Set your layout here
        ...
        calendarView.setOnDateChangeListener((view, year, month, dayOfMonth) -> {
            ...
            switch (currentDay) {
                case 1:
                    loadFragment(new Day1_specific_training_box());
                    break;
                case 2:
                    loadFragment(new Day2_specific_training_box());
                    break;
                case 3:
                    loadFragment(new Day3_specific_training_box());
                    break;
                case 4:
                    loadFragment(new Day4_specific_training_box());
                    break;
                case 5:
                    loadFragment(new Day5_specific_training_box());
                    break;
                case 6:
                    loadFragment(new Day6_specific_training_box());
                    break;
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_item_layout1) {
                    Intent intent = new Intent(Specific_preparation_schedule.this, MainActivity.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout2) {
                    Intent intent = new Intent(Specific_preparation_schedule.this, Calendar_schedule.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout3) {
                    Intent intent = new Intent(Specific_preparation_schedule.this, Login.class);
                    startActivity(intent);
                }
                return true;
            }
