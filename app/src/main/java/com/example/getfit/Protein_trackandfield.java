...
public class Protein_trackandfield extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_protein_trackandfield);
        mClickable=findViewById(R.id.food_sources);
        mClickable.setOnClickListener(v -> startActivity(new Intent(getApplicationContext(),TrackAndField_protein_food_sources.class)));
        ...
        if (!savedWeight.isEmpty()) {
            ...
            float easyLowValue = (float) (1.2* weight);
            float easyHighValue= (float) (1.6*weight);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_item_layout1) {
                    Intent intent = new Intent(Protein_trackandfield.this, MainActivity.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout2) {
                    Intent intent = new Intent(Protein_trackandfield.this, TrackAndField.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout3) {
                    Intent intent = new Intent(Protein_trackandfield.this, Login.class);
                    startActivity(intent);
                }
                return true;
            }
