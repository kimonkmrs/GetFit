...
public class Carbohydrate_Intake_Strategies_tennis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carbohydrate_intake_strategies_tennis);
        ...
        if (!savedWeight.isEmpty()) {
            ...
            float midHighValue= 8 * weight;
            float GamePrep1 = 8 * weight;
            float GamePrep2 = 10 * weight;
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_item_layout1) {
                    Intent intent = new Intent(Carbohydrate_Intake_Strategies_tennis.this, MainActivity.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout2) {
                    Intent intent = new Intent(Carbohydrate_Intake_Strategies_tennis.this, Tennis.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout3) {
                    Intent intent = new Intent(Carbohydrate_Intake_Strategies_tennis.this, Login.class);
                    startActivity(intent);
                }
                return true;
            }
