...
public class Early_pre_season_tennis_schedule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_early_pre_season_tennis_schedule); // Set your layout here
        ...
        calendarView.setOnDateChangeListener((view, year, month, dayOfMonth) -> {
            ...
            switch (currentDay) {
                case 1:
                    loadFragment(new Day1_early_pre_season_tennis());
                    break;
                case 2:
                case 6:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    loadFragment(new Day2_early_pre_season_tennis());
                    break;
                default:
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_item_layout1) {
                    Intent intent = new Intent(Early_pre_season_tennis_schedule.this, MainActivity.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout2) {
                    Intent intent = new Intent(Early_pre_season_tennis_schedule.this, Calendar_schedule.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout3) {
                    Intent intent = new Intent(Early_pre_season_tennis_schedule.this, Login.class);
                    startActivity(intent);
                }
                return true;
            }
