...
public class Fat_volley_intake_strategies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fat_volley_intake_strategies);
        ...
        mWeight.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (!s.toString().isEmpty()) {
                    ...
                    float easyLowValue = (float) (3* weight);
                    float easyHighValue= (float) (4*weight);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_item_layout1) {
                    Intent intent = new Intent(Fat_volley_intake_strategies.this, MainActivity.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout2) {
                    Intent intent = new Intent(Fat_volley_intake_strategies.this, Volleyball.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout3) {
                    Intent intent = new Intent(Fat_volley_intake_strategies.this, Login.class);
                    startActivity(intent);
                }
                return true;
            }
