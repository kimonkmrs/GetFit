...
public class Day4_trackandfield extends Fragment {
    ...
    public View onCreateView(
        ...
        View view = inflater.inflate(R.layout.fragment_day4_trackandfield, container, false);
        ...
        backSquatsImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(requireContext(), VideoPlayerTrackAndFieldDay4_1.class);
        ...
        backSquatsImageView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Launch the VideoPlayerFootball activity when the image is clicked
                Intent intent = new Intent(requireContext(), VideoPlayerTrackAndFieldDay4_2.class);
                startActivity(intent);
            }
        });
        backSquatsImageView3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Launch the VideoPlayerFootball activity when the image is clicked
                Intent intent = new Intent(requireContext(), VideoPlayerTrackAndFieldDay4_3.class);
                startActivity(intent);
            }
        });
        backSquatsImageView4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Launch the VideoPlayerFootball activity when the image is clicked
                Intent intent = new Intent(requireContext(), VideoPlayerTrackAndFieldDay4_4.class);
                startActivity(intent);
            }
        });
