...
public class Late_pre_season_tennis_schedule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_late_pre_season_tennis_schedule); // Set your layout here
        ...
        calendarView.setOnDateChangeListener((view, year, month, dayOfMonth) -> {
            ...
            switch (currentDay) {
                case 1:
                    loadFragment(new Day1_pre_season_tennis());
                    break;
                case 2:
                case 6:
                ...
                case 4:
                    ...
                    break;
                case 3:
                    loadFragment(new Day2_pre_season_tennis());
                    break;
                case 5:
                    loadFragment(new Day3_pre_season_tennis());
                    break;
                default:
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_item_layout1) {
                    Intent intent = new Intent(Late_pre_season_tennis_schedule.this, MainActivity.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout2) {
                    Intent intent = new Intent(Late_pre_season_tennis_schedule.this, Calendar_schedule.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout3) {
                    Intent intent = new Intent(Late_pre_season_tennis_schedule.this, Login.class);
                    startActivity(intent);
                }
                return true;
            }
