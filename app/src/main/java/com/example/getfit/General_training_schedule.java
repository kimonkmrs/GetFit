...
public class General_training_schedule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_general_training_schedule); // Set your layout here
        ...
        calendarView.setOnDateChangeListener((view, year, month, dayOfMonth) -> {
            ...
            switch (currentDay) {
                case 1:
                    loadFragment(new Day1_general_training_box());
                    break;
                case 2:
                    loadFragment(new Day2_general_training_box());
                    break;
                case 3:
                    loadFragment(new Day3_general_training_box());
                    break;
                case 4:
                    loadFragment(new Day4_general_training_box());
                    break;
                case 5:
                case 7:
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_item_layout1) {
                    Intent intent = new Intent(General_training_schedule.this, MainActivity.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout2) {
                    Intent intent = new Intent(General_training_schedule.this, Calendar_schedule.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout3) {
                    Intent intent = new Intent(General_training_schedule.this, Login.class);
                    startActivity(intent);
                }
                return true;
            }
