...
public class Carbohydrate_Intake_Strategies_volley extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carbohydrate_intake_strategies_volley);
        ...
        if (!savedWeight.isEmpty()) {
            ...
            float easyLowValue = 6 * weight;
            float easyHighValue = 8 * weight;
            float midLowValue= 8 * weight;
            float midHighValue=10*weight;
            float GamePrep1 = 1 * weight;
            float GamePrep2= (float) (1.5*weight);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_item_layout1) {
                    Intent intent = new Intent(Carbohydrate_Intake_Strategies_volley.this, MainActivity.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout2) {
                    Intent intent = new Intent(Carbohydrate_Intake_Strategies_volley.this, Volleyball.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout3) {
                    Intent intent = new Intent(Carbohydrate_Intake_Strategies_volley.this, Login.class);
                    startActivity(intent);
                }
                return true;
            }
