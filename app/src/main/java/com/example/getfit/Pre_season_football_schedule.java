...
public class Pre_season_football_schedule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_season_football_schedule); // Set your layout here
        ...
        calendarView.setOnDateChangeListener((view, year, month, dayOfMonth) -> {
            ...
            switch (currentDay) {
                case 1:
                    loadFragment(new Day1_football());
                    break;
                case 2:
                    loadFragment(new Day2_football());
                    break;
                case 3:
                case 7:
                    ...
                    break;
                case 4:
                    loadFragment(new Day3_football());
                    break;
                case 5:
                    loadFragment(new Day4_football());
                    break;

                // Handle other days similarly
                case 6:
                    loadFragment(new Day5_football());
                    break;
                default:
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (itemId == R.id.menu_item_layout1) {
                    Intent intent = new Intent(Pre_season_football_schedule.this, MainActivity.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout2) {
                    Intent intent = new Intent(Pre_season_football_schedule.this, Calendar_schedule.class);
                    startActivity(intent);
                } else if (itemId == R.id.menu_item_layout3) {
                    Intent intent = new Intent(Pre_season_football_schedule.this, Login.class);
                    startActivity(intent);
                }
                return true;
            }
